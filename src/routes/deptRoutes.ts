...
import { allDepartmentHandler, createDepartmentHandler, deleteDepartmentHandler, findDepartmentByIdHandler, updateDepartmentHandler } from '../controllers/deptController';
